...
<div class="container">
	...
	<div class="title-container">
		...
		<a href="{{route('admin.changeorderstatus', ['id' => $order->id_MotoOrder, 'action' => 1])}}" class="btn btn-success mr-3 mt-3" role="button">Patvirtinti skelbimą</a>
		<a href="{{route('admin.changeorderstatus', ['id' => $order->id_MotoOrder, 'action' => 0])}}" class="btn btn-danger mr-3 mt-3" role="button">Atšaukti skelbimą</a>
